...
//$l['acp.userManagement.title'] = 'User management';
...
$l['acp.userManagement.form.user.addDescription'] = 'Create user';
//$l['acp.userManagement.form.user.editDescription'] = 'Benutzer bearbeiten';
$l['acp.userManagement.form.user.editDescription'] = 'Edit user';
//$l['acp.userManagement.form.user.name'] = 'Benutzername';
$l['acp.userManagement.form.user.name'] = 'Userername';
//$l['acp.userManagement.form.user.name.description'] = 'Name des Benutzers';
$l['acp.userManagement.form.user.name.description'] = 'Name of the user';
//$l['acp.userManagement.form.user.pass1'] = 'Passwort';
$l['acp.userManagement.form.user.pass1'] = 'Password';
//$l['acp.userManagement.form.user.pass1.description'] = 'Passwort des Benutzers';
$l['acp.userManagement.form.user.pass1.description'] = 'Password of the user';
//$l['acp.userManagement.form.user.pass2'] = 'Passwort wiederholung';
$l['acp.userManagement.form.user.pass2'] = 'Repeat password';
//$l['acp.userManagement.form.user.pass2.description'] = 'Das Passwort nochmals eingeben um schreibfehler zu vermeiden';
$l['acp.userManagement.form.user.pass2.description'] = 'Enter the password again to avoid typing errors';
//$l['acp.userManagement.form.user.mainGroup'] = 'Hauptgruppe';
$l['acp.userManagement.form.user.mainGroup'] = 'Main group';
//$l['acp.userManagement.form.user.mainGroup.description'] = 'Hauptgruppe des Benutzers';
$l['acp.userManagement.form.user.mainGroup.description'] = 'Main group of user';
//$l['acp.userManagement.form.user.userGroups'] = 'Benutzergruppen';
$l['acp.userManagement.form.user.userGroups'] = 'User groups';
//$l['acp.userManagement.form.user.userGroups.description'] = 'Benutzergruppen zu denen der Benutzer zugeordnet wird';
$l['acp.userManagement.form.user.userGroups.description'] = 'User groups to which the user is assigned';
//$l['acp.userManagement.form.user.lang'] = 'Sprache';
$l['acp.userManagement.form.user.lang'] = 'Language';
//$l['acp.userManagement.form.user.lang.description'] = 'Sprache in der das SHC dem Benutzer angezeigt wird';
$l['acp.userManagement.form.user.lang.description'] = 'Language in which the SHC will be displayed to the user';
...
$l['acp.userManagement.form.user.webStyle.description'] = 'Style of webinterface';
//$l['acp.userManagement.form.group.tab1.title'] = 'Allgemeine Daten';
$l['acp.userManagement.form.group.tab1.title'] = 'General data';
...
$l['acp.userManagement.form.group.tab3.description'] = 'Administrator rights of the group';
//$l['acp.userManagement.form.group.name'] = 'Name';
$l['acp.userManagement.form.group.name'] = 'Name';
//$l['acp.userManagement.form.group.name.description'] = 'Name der Benutzergruppe';
$l['acp.userManagement.form.group.name.description'] = 'Name of the user group';
//$l['acp.userManagement.form.group.desc'] = 'Beschreibung';
$l['acp.userManagement.form.group.desc'] = 'Description';
